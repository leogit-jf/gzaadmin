@extends('gzaadmin::grid.inline-edit.comm')
@section('field')
    <select name='select-{{ $name }}' class="form-control ie-input select2-edit" >
...
@section('assert')
    <script>
        @component('gzaadmin::grid.inline-edit.partials.popover', compact('trigger'))
            @slot('content')
    ...
    <script>
    @component('gzaadmin::grid.inline-edit.partials.submit', compact('resource', 'name'))
