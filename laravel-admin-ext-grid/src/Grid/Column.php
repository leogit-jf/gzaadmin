...
namespace GzaAdmin\Admin\Grid;

use Closure;
use Encore\Admin\Actions\RowAction;
use Encore\Admin\Grid;
use GzaAdmin\Admin\Grid\Displayers\AbstractDisplayer;
use GzaAdmin\Admin\Grid\Column\InlineEditing;
use GzaAdmin\Admin\Grid\Column\ExtendDisplay;
...
class Column extends Grid\Column
{
    ...
    public function action($action)
    {
        if (!is_subclass_of($action, RowAction::class)) {
            throw new \InvalidArgumentException("Action class [$action] must be sub-class of [GzaAdmin\Admin\Actions\GridAction]");
        }
    ...
    {
        if (array_key_exists($abstract, static::$Gzadisplayers)) {
            return $this->callBuiltinDisplayer(static::$Gzadisplayers[$abstract], $arguments);
        }
